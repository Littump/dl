...
from lib.models import Experiment3Model
from lib.train import train_model, set_seed
from lib.utils import get_device, save_experiment_summary

EXPERIMENT_NAME = "Experiment 3 - Skip Connections and Batch Normalization"
HIDDEN_SIZE = 128
NUM_BLOCKS = 3
...
if __name__ == "__main__":
    ...
    model = Experiment3Model(input_dim=input_dim)
    print(model)
